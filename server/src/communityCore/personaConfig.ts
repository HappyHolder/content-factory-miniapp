...
export function parsePersonaConfig(raw: unknown): PersonaConfigData {
  ...
  return {
    identity: {
      ...
      occupation: str(identity.occupation, d.identity.occupation, 120),
      about: str(identity.about, '', 500),
    },
    voice: {
      messageExamples: list(voice.messageExamples, 6, 300),
      speechStyle: str(voice.speechStyle, d.voice.speechStyle, 200),
      slang: str(voice.slang, '', 200),
    ...
    canon: list(r.canon, 30, 300),
    role: str(r.role, d.role, 80),
    interests: list(r.interests, 15, 60),
    behavior: {
      ...
      expertTopics: list(behavior.expertTopics, 15, 60),
      forbiddenTopics: list(behavior.forbiddenTopics, 15, 60),
      extraInstructions: str(behavior.extraInstructions, '', 1200),
