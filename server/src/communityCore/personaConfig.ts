...
export function parsePersonaConfig(raw: unknown): PersonaConfigData {
  ...
  return {
    identity: {
      ...
      about: str(identity.about, '', 8000),
    },
    voice: {
      messageExamples: list(voice.messageExamples, 20, 1500),
      speechStyle: str(voice.speechStyle, d.voice.speechStyle, 1000),
    ...
    canon: list(r.canon, 50, 2000),
    role: str(r.role, d.role, 200),
    interests: list(r.interests, 30, 120),
    behavior: {
