...
const variants:Record<string,string[]>={
  ...
  harassment:['Личные оскорбления прекращаем. Обсуждайте поступки и аргументы, не человека.','Стоп. Не объединяйтесь против участника и не переходите на личные выпады.','Сбавьте давление на человека. Продолжайте только по существу и без травли.'],
