...
export async function advanceActiveActivities(now=new Date()){
  ...
  for(const activity of rows){
    ...
    try{
      ...
      if(reserved&&!sent)await refundSubscriptionQuota(activity.communityManager.community.channel.userId,'communityManagerActions');
