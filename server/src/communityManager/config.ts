export type CommunityManagerConfigData = {
  ...
  replies: { replyToDirectReply: boolean; replyToMention: boolean; replyToProductQuestion: boolean; replyToUnansweredQuestion: boolean; ambientConversation: boolean; ambientCooldownMinutes: number; unansweredAfterMinutes: number; maxThreadDepth: number; userCooldownSeconds: number };
...
export const DEFAULT_CM_CONFIG: CommunityManagerConfigData = {
  ...
  replies: { replyToDirectReply: true, replyToMention: true, replyToProductQuestion: true, replyToUnansweredQuestion: false, ambientConversation: false, ambientCooldownMinutes: 5, unansweredAfterMinutes: 15, maxThreadDepth: 4, userCooldownSeconds: 30 },
  activities: { enabled: false, requireApproval: true, discussionEnabled: true, pollEnabled: true, gameEnabled: true, digestEnabled: true, silenceMinutes: 60, everyHours: 24, maxInitiativesPerWeek: 3, responseWindowMinutes: 120, topics: [] },
  limits: { timezone: 'Europe/Moscow', quietFrom: 23, quietTo: 9, maxRepliesPerHour: 20, maxRepliesPerDay: 100, maxInitiativesPerDay: 1 },
};
...
export function parseCommunityManagerConfig(raw: unknown): CommunityManagerConfigData {
  ...
  return {
    ...
    replies:{replyToDirectReply:bool(replies.replyToDirectReply,d.replies.replyToDirectReply),replyToMention:bool(replies.replyToMention,d.replies.replyToMention),replyToProductQuestion:bool(replies.replyToProductQuestion,d.replies.replyToProductQuestion),replyToUnansweredQuestion:bool(replies.replyToUnansweredQuestion,d.replies.replyToUnansweredQuestion),ambientConversation:bool(replies.ambientConversation,d.replies.ambientConversation),ambientCooldownMinutes:num(replies.ambientCooldownMinutes,d.replies.ambientCooldownMinutes,1,240),unansweredAfterMinutes:num(replies.unansweredAfterMinutes,d.replies.unansweredAfterMinutes,1,240),maxThreadDepth:num(replies.maxThreadDepth,d.replies.maxThreadDepth,1,10),userCooldownSeconds:num(replies.userCooldownSeconds,d.replies.userCooldownSeconds,0,3600)},
    activities:{enabled:bool(activities.enabled,d.activities.enabled),requireApproval:bool(activities.requireApproval,d.activities.requireApproval),discussionEnabled:bool(activities.discussionEnabled,d.activities.discussionEnabled),pollEnabled:bool(activities.pollEnabled,d.activities.pollEnabled),gameEnabled:bool(activities.gameEnabled,d.activities.gameEnabled),digestEnabled:bool(activities.digestEnabled,d.activities.digestEnabled),silenceMinutes:num(activities.silenceMinutes,d.activities.silenceMinutes,15,10080),everyHours:num(activities.everyHours,d.activities.everyHours,1,168),maxInitiativesPerWeek:num(activities.maxInitiativesPerWeek,d.activities.maxInitiativesPerWeek,1,20),responseWindowMinutes:num(activities.responseWindowMinutes,d.activities.responseWindowMinutes,15,1440),topics:list(activities.topics,50,160)},
