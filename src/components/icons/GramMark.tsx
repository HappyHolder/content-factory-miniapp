interface GramMarkProps {
  size?: number
  className?: string
}

// Gram currency mark (blue diamond + white sparkle). Brand asset — keeps its own
// colors rather than currentColor.
export function GramMark({ size = 18, className }: GramMarkProps) {
  return (
    <svg
      width={size}
      height={size}
