...
const DEFAULT: AntiSpamBlock = { id: 'antispam-default', type: 'antispam', enabled: false, floodEnabled: true, maxMessages: 6, windowSeconds: 10, duplicateEnabled: true, maxDuplicates: 3, duplicateWindowSeconds: 60, linksMode: 'allow', allowedDomains: [], action: 'delete', skipBots: true, skipAdmins: true, skipTrusted: true }
